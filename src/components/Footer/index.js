      ...
      <section className="firstContainerFooter">
        ...
        <div className="containerFooterContact">
          ...
          <div className="contactNumberFooter">
            ...
            <div className="groupFooterContact"> 
              <a href="https://www.google.fr/maps/place/2%C2%B050'14.5%22N+9%C2%B053'07.3%22E/@2.8356543,9.8849632,883m/data=!3m1!1e3!4m5!3m4!1s0x0:0x0!8m2!3d2.8373611!4d9.8853611" className="oneFooterContact" target="_blank">Hôtel Mimado<br/>Bongahélé GrandBatanga II Kribi</a>
            </div>
          </div>
        </div>
