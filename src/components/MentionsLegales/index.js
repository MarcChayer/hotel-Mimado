...
const MentionsLegales = () => (
  <div className="mentionsLegales">
    ...
    <div className="paragrapheMention">
      ...
      <p className="textMentions">Paiement uniquement en espèces.</p>
    </div>
  </div>
);
